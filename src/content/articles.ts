...
<p>Marketplace facilitator laws in every sales-tax state make Amazon collect and remit sales tax on marketplace orders. For most FBA sellers, that part is genuinely handled.</p>
...
<li><strong>Bookkeeping hygiene.</strong> Tax that flows through your account must sit in a liability account, not revenue. Booked as revenue, it inflates your sales and your tax bill.</li>
</ul>
...
<p>The line on an Amazon order page that reads "estimated tax to be collected" is this same destination-rate calculation, shown before the order finalizes. It's labeled estimated because the final figure locks when the item ships, and it can move a few cents if part of the order ships separately or a promotion applies after checkout. On your side, that number lands in the settlement report as tax collected and, one line later, as tax withheld by Amazon as the marketplace facilitator. Net effect on your bank account: zero. Net effect on your books: also zero, as long as neither line gets posted to revenue.</p>
...
`,
  },
  {
    ...
    html: `
<p>OnlyFans income is self-employment income. You owe regular income tax plus 15.3% self-employment tax on your net profit, nothing is withheld from your payouts, and every January a 1099-NEC arrives from Fenix Internet LLC (OnlyFans' payment entity) if you earned $600 or more.</p>
<p>That's the whole framework. The rest of this guide is the detail that decides whether you handle it cheaply and calmly or expensively and in a panic, written the way we work with creators: professionally, concretely, and without commentary about the content.</p>
...
<p>OnlyFans keeps 20% of everything: subscriptions, tips, PPV, customs. On $10,000 of monthly fan spending, you receive $8,000. Small bookkeeping decision, real consequences. Record $8,000 of income and the fee vanishes from your books: revenue understated, expenses understated, nothing to reconcile against the dashboard. Record $10,000 gross with a $2,000 platform-fee expense and your books match reality, your true cost of doing business on the platform is visible, and the January tie-out takes minutes.</p>
...
<p>A creator netting $100,000 of profit (after the platform fee and expenses) owes roughly $14,100 in self-employment tax. Add federal income tax of about $13,000 to $17,000, depending on filing status and deductions, plus state income tax in most states. Call it $30,000 to $37,000 all-in. The number isn't the scary part; the scary part is that no one withheld a cent of it, so an unprepared creator meets the whole figure at once in April.</p>
...
<p>This is common in this industry, more common than anyone admits, and it's fixable. The sequence matters: rebuild the books first, then file, because returns filed from guesses tend to overstate tax (missed deductions) or invite scrutiny (numbers that don't tie to the 1099-NECs on file). Rebuilding is mechanical when the records exist, and they do: Fenix payout history, bank statements and platform dashboards cover everything needed to reconstruct gross earnings, fees, chargebacks and expenses for past years.</p>
<p>Penalties for late filing are real but they compound with delay, and the IRS is measurably easier on people who show up voluntarily with clean numbers than on people it has to find. We handle the rebuild side as <a href="/catch-up-bookkeeping-services/">catch-up bookkeeping</a> and coordinate the filings with a CPA who has seen creator returns before.</p>

<h2>OnlyFans tax FAQ</h2>
<p><strong>Do I have to pay tax on OnlyFans income?</strong> Yes, from the first dollar. It's self-employment income: regular income tax plus 15.3% self-employment tax on net profit, and state income tax in most states. The $600 1099-NEC threshold decides whether a form arrives, not whether tax is owed, and filing is generally required once self-employment earnings pass $400.</p>
<p><strong>Does OnlyFans take taxes out of my payouts?</strong> No. The 20% platform fee isn't tax, and nothing is withheld. Setting aside 25 to 30% of each payout is the substitute.</p>
<p><strong>What tax form does OnlyFans send?</strong> A 1099-NEC from Fenix Internet LLC, for US creators who earned $600 or more in the year. Under $600 no form arrives, but the income still goes on Schedule C.</p>
<p><strong>Can I deduct the 20% OnlyFans fee?</strong> Yes, as commissions and fees on Schedule C, provided you booked gross earnings as income. Record net payouts as income instead and there's nothing left to deduct.</p>

<h2>Why creators need an accountant who won't flinch</h2>
<p>Here's the part nobody puts on their website: OnlyFans creators get refused by accounting firms, dropped by banks and payment processors, and lectured by professionals who happily serve bars and gun shops. The result is predictable. Creators running six-figure businesses do their own taxes badly, trust a friend-of-a-friend, or don't file. Every one of those paths costs multiples of what professional help would have.</p>
...
<h2>QuickBooks Online pricing by plan, 2025 vs 2026</h2>
<p>Sellers comparing QuickBooks prices from 2025 against this year's list are looking at one step-up, taken mid-year. Official 2025 pricing opened the year at $35 for Simple Start, $65 for Essentials, $99 for Plus and $235 for Advanced. Intuit's mid-2025 increase moved those to $38, $75, $115 and $275, and that schedule carried into 2026 unchanged: the QuickBooks Online pricing in January 2026 and February 2026 matched the table above, and nothing has moved since (effective July 1, 2025 for client-billed subscriptions and August 1, 2025 for accountant-billed ones). So the QuickBooks Online Plus monthly price in the US went from $99 to $115 inside twelve months, a 16% jump. Advanced rose 17%, Essentials 15%, and Simple Start moved least in dollars ($3) while still climbing 9%. For a small business building a 2026 budget off a 2025 quote, add those percentages before signing anything. The pricing tiers and the features attached to each didn't change with the price: Plus still holds classes, locations and inventory, Advanced still holds the higher limits.</p>
<p>Cost per year, on Intuit's official 2026 pricing plans: Simple Start $456, Essentials $900, Plus $1,380, Advanced $3,300. On the early-2025 rates the same plans ran $420, $780, $1,188 and $2,820, so a Plus subscriber pays $192 more per year than they would have in January 2025. Whatever month of 2026 you're reading this in, those are the QuickBooks rates to budget.</p>

<h2>How much does QuickBooks Online cost per year, plan by plan?</h2>
<p>Monthly prices hide the annual number, and the annual number is what belongs in a budget. At 2026 list, the QuickBooks Online Simple Start price per month is $38 USD, or $456 a year. Essentials is $75, or $900 a year. QuickBooks Online Plus pricing lands at $115 a month, $1,380 a year, and the Advanced plan costs $275 a month, $3,300 a year. Solopreneur, the renamed Self-Employed product, is $25 a month, $300 a year. Intuit bills monthly by default and doesn't offer a meaningful annual discount, so paying yearly mostly locks in a price before the next increase.</p>
...
<p><strong>How much does QuickBooks Online cost in 2026?</strong> $25 (Solopreneur), $38 (Simple Start), $75 (Essentials), $115 (Plus) or $275 (Advanced) per month at US list price, before promotional discounts. Most ecommerce sellers land on Plus. Same answer whether you searched QBO subscription prices, QBO online prices or "quick book online pricing"; Intuit publishes one list.</p>
...
<h2>Reading the FBA reimbursement report in Seller Central</h2>
<p>The FBA reimbursement report lives under Reports, then Fulfillment, then Payments, listed as Reimbursements. Each row is one payout Amazon made to you, and five columns do the work. The reason code says why: Lost_Warehouse, Damaged_Warehouse, CustomerReturn, Lost_Inbound and so on. The case ID ties back to the claim you filed; a blank case ID means Amazon reimbursed on its own. Quantity reimbursed cash versus quantity reimbursed inventory tells you whether Amazon paid money or put a replacement unit back into your stock, and those need different bookkeeping: cash offsets shrinkage, a replacement unit reverses the inventory write-off. Amount per unit is the cost basis Amazon used, which since 2025 should match the manufacturing cost you filed. When it doesn't, that row is a dispute, not a closed item.</p>
<p>Run the report monthly against the Inventory Ledger with one question: which lost, damaged or refunded-but-never-returned events in the ledger have no matching reimbursement? Those are your open claims. Then run the reverse check. Units Amazon reimbursed and later marked "found" come back as a reversal row, and a seller who booked the original payout as revenue now has phantom income to unwind.</p>
